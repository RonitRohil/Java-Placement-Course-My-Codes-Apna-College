...
public class DetectCycle_UndirectedGraph_BFS {
 ...
 * We have an an undirected graph, how to check if there is a cycle in 
 * the graph? For example, the following graph has a cycle 1-0-2-1.
 * 
 * Input :
 * 
 * 9 - 5 - 2
