 ...
 * (or cut vertex) if removing it (and edges through it) increases the 
 ...
 * 
 * Tarjan's Algorithm 
 * it works on ancestor and child framework
 * 
 * - Ancestor
 *   A node A that was discoverd before curr node in DFS, is the 
 *   ancestor of curr.
 *   We use discovery time to find ancestor
 * 
 * 
 * 
 */